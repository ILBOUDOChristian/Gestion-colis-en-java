 ...
 */
public class formtabretrait extends javax.swing.JPanel {

    
    
    public formtabretrait() {
        initComponents();
       
    DefaultTableModel t=(DefaultTableModel) tabretrait.getModel();
         t.setRowCount(0);
         classe.retrait.actualiser(t); 
    ...
    private void initComponents() {
        ...
        tabretrait = new javax.swing.JTable();
        ...
        tabretrait.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Date", "Id", "Expediteur", "Recepteur", "N°paquets", "Type", "Ville A", "Tel Recep"
            }
        ));
        tabretrait.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        tabretrait.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tabretraitMouseReleased(evt);
            }
        });
        jScrollPane1.setViewportView(tabretrait);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/viewmag--icone-5948-32.png"))); // NOI18N
    ...
    private void btnmodifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodifierActionPerformed
        ...
        DefaultTableModel t = (DefaultTableModel) tabretrait.getModel();
        int selectedRowIndex = tabretrait.getSelectedRow();
    ...
    private void btnexporterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexporterActionPerformed
        try {
            ...
            DefaultTableModel tab = (DefaultTableModel) tabretrait.getModel();
    ...
    private void tabretraitMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabretraitMouseReleased
       DefaultTableModel t = (DefaultTableModel) tabretrait.getModel();
        int selectedRowIndex = tabretrait.getSelectedRow();

        if (selectedRowIndex >= 0) {
            String[] columnNames = { "Date Retrait","Identifiant", "Expéditeur", "Récepteur", "Nombre de Paquets", "Type", "Ville d'Arrivée", "Téléphone Récepteur"};
            String selectedColumn = (String) JOptionPane.showInputDialog(null, "Veuillez choisir la colonne à modifier",
                "Choisir Colonne", JOptionPane.QUESTION_MESSAGE, null, columnNames, columnNames[0]);
            ...
            if (selectedColumn != null) {
                ...
                if (selectedColumnIndex != -1) {
                    ...
                    if (newValue != null && !newValue.trim().isEmpty()) {
                        ...
                        // Récupération des valeurs mises à jour
                        String dateRetrait = t.getValueAt(selectedRowIndex, 0).toString();
                        String identifiant = t.getValueAt(selectedRowIndex, 1).toString();
                        String expediteur = t.getValueAt(selectedRowIndex, 2).toString();
                        String recepteur = t.getValueAt(selectedRowIndex, 3).toString();
                        String nombrePaquets = t.getValueAt(selectedRowIndex, 4).toString();
                        String type = t.getValueAt(selectedRowIndex, 5).toString();
                        String villeArrive = t.getValueAt(selectedRowIndex, 6).toString();
                        String telRecepteur = t.getValueAt(selectedRowIndex, 7).toString();

                        // Mise à jour de la base de données
                        try {
                            classe.retrait.modifier(dateRetrait, identifiant,expediteur, recepteur, nombrePaquets, type, villeArrive, telRecepteur);
                        } catch (FileNotFoundException ex) {
    ...
    }//GEN-LAST:event_tabretraitMouseReleased
    ...
    public javax.swing.JTable tabretrait;
